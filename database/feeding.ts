...
export type FeedingPayload = Omit<FeedingInsert, 'id' | 'recordedAt' | 'babyId'> & { babyId?: number };
...
export async function getFeedingById(feedingId: number, babyId?: number): Promise<FeedingRecord | null> {
