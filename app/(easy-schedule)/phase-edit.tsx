...
export default function PhaseEditScreen() {
  ...
  // Mutation for adjusting schedule phase timing
  const adjustPhaseTiming = useMutation(api.easyFormulaRules.adjustPhaseTiming);
        ...
        const activityLabel =
          activityType === "E"
            ...
            ? t("easySchedule.activityLabels.eatAndActivity", {
                defaultValue: `${t("easySchedule.activityLabels.eat")} & ${t(
                  "easySchedule.activityLabels.activity"
                )}`,
              })
            : activityType === "S"
            ...
            <View className="flex-1">
              ...
              <Text className="text-lg text-muted-foreground">
                {formatDuration(
                  newDuration > 0
                    ? newDuration
                    : initialEndMinutes - initialStartMinutes
                )}
              </Text>
            </View>
          </View>
