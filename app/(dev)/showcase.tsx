        ...
        <View className="gap-2">
          ...
          <View className="flex-row flex-wrap gap-2">
            <Badge variant="default" asChild>
              <Pressable onPress={() => console.log('Pressed Default')}>
                <Text>Press Me</Text>
              </Pressable>
            </Badge>
            <Badge variant="secondary" asChild>
              <Pressable onPress={() => console.log('Pressed Secondary')}>
                <Text>Press Me</Text>
              </Pressable>
            </Badge>
            <Badge variant="outline" asChild>
              <Pressable onPress={() => console.log('Pressed Outline')}>
                <Text>Press Me</Text>
              </Pressable>
            </Badge>
          </View>
        ...
        <View className="gap-2">
          ...
          <View className="flex-row flex-wrap gap-2">
            <Badge className="bg-blue-500">
              <Text className="text-white">Custom BG</Text>
            </Badge>
            <Badge variant="outline" className="border-purple-500">
              <Text className="text-purple-500">Custom Border</Text>
            </Badge>
          </View>
        </View>
      </View>
